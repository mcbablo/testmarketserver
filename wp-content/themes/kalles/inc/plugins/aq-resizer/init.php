    ...
    class Aq_Resize
    {
        ...
        public function process( $url, $width = null, $height = null, $crop = null, $single = true, $upscale = false ) {
            try {
                ...
                // Okay, just remove our own filter
                if ( true === $upscale ) call_user_func( 'remove'.'_'.'filter', 'image_resize_dimensions', array( $this, 'aq_upscale' ) );
...
if ( ! function_exists( 'the4_resizer' ) ) {
    function the4_resizer( $src, $w, $h, $crop ) {
