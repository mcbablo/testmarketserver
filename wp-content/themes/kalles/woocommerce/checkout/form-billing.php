...
<div class="woocommerce-billing-fields">
	<?php if ( wc_ship_to_billing_address_only() && WC()->cart->needs_shipping() ) : ?>
		...
		<h3><?php esc_html_e( 'Billing &amp; Shipping', 'kalles' ); ?></h3>

	<?php else : ?>

		<h3><?php esc_html_e( 'Billing details', 'kalles' ); ?></h3>
	...
	<div class="woocommerce-account-fields">
		<?php if ( ! $checkout->is_registration_required() ) : ?>
			...
			<p class="form-row form-row-wide create-account pr style-checkbox">
				...
				<label for="createaccount" class="woocommerce-form__label woocommerce-form__label-for-checkbox checkbox"></label><span><?php esc_html_e( 'Create an account?', 'kalles' ); ?></span>
			</p>
