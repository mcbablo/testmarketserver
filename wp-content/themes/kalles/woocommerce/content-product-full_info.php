<?php
/**
 * Content product loop - full info on Image
 *
 * @since   1.0.0
 * @package Kalles
 */
...
$is_coundown = ( ! empty( $kalles_sc['countdown'] ) && ! empty( $end ) && ! empty ( $now ) && $date_end >= $date_now ) ? ' product-countdown' : '';
 ...
 ?>
<div class="product__lop-top_information">
	<?php
	...
	?>
</div> <!-- .product__lop-top_information -->
...
<div class="product__lop-bottom_information">
	<div class="product-info__inner">
		<?php
			 ...
			 */
			?>
			<div class="dn list_view-product_title">
				<?php
					do_action( 'woocommerce_shop_loop_item_title' );
				?>
			</div>
