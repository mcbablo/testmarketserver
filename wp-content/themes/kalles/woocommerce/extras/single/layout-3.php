...
?>
<div class="the4-wc-single wc-single-3 mb__60 <?php echo esc_attr($buynow_btn_layout); ?> <?php if ( cs_get_option( 'wc-single-buynow_btn' ) ) echo 'has-buy-now'; ?>">
    <?php
    ...
    <div id="product-<?php the_ID(); ?>" <?php post_class( 'mt__40 zoom-lazyload' ); ?>>
        <div class="row flex">
            <div class="<?php echo esc_attr($content_class) ?>">
                <div class="row">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12 pr mb__30">
                        <div class="summary entry-summary the4-sidebar-sticky ts__05">
                            <?php
                            /**
