...
<div class="the4-wc-single wc-single-1 mb__60 <?php echo esc_attr( $thumb_position ); ?> <?php echo esc_attr($buynow_btn_layout); ?> <?php if ( cs_get_option( 'wc-single-buynow_btn' ) ) echo 'has-buy-now'; ?>">
	<?php
