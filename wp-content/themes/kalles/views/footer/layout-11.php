<?php
/**
 * The footer layout 11.
 *
 * @since   1.4.6
 * @package Kalles
 */
?>
<footer id="the4-footer" class="bgbl footer-11 <?php if (cs_get_option('enable_footer-sticky') ) { ?> footer-sticky <?php }?>" <?php the4_kalles_schema_metadata( array( 'context' => 'footer' ) ); ?>>
    <?php if ( is_active_sidebar( 'footer-1' ) || is_active_sidebar( 'footer-2' ) || is_active_sidebar( 'footer-3' ) || is_active_sidebar( 'footer-4' ) || is_active_sidebar( 'footer-5' ) ) : ?>
        ...
        ?>
        <div class="footer__top pb__80 pt__80 <?php if ( is_active_sidebar( 'footer-mobile' ) && cs_get_option('enable_footer-mobile') ) { ?> db_md <?php }?>">
