 ...
 */
?>
<footer id="the4-footer" class="bgbl footer-2 <?php if (cs_get_option('enable_footer-sticky') ) { ?> footer-sticky <?php }?>" <?php the4_kalles_schema_metadata( array( 'context' => 'footer' ) ); ?>>
