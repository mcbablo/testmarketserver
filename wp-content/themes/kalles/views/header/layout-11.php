<?php
/**
 * The header layout 11.
 *
 * @since   1.0.0
 * @package Kalles
 */
?>
<header id="the4-header" class="header-3 header-11 <?php echo ( cs_get_option( 'menu-arrow' ) ? ' menu-item-arrow' : '' ); ?> <?php echo esc_attr( ( cs_get_option( 'menu-uppercase' ) ? ' menu-item-uppercase' : '' ) ); ?>" <?php the4_kalles_schema_metadata( array( 'context' => 'header' ) ); ?>>
