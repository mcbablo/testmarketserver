<?php
/**
 * The header layout 20.
 *
 * @since   1.0.0
 * @package Kalles
 */
?>
<header id="the4-header" class="header-3 header-20 <?php echo ( cs_get_option( 'menu-arrow' ) ? ' menu-item-arrow' : '' ); ?> <?php echo esc_attr( ( cs_get_option( 'menu-uppercase' ) ? ' menu-item-uppercase' : '' ) ); ?>" <?php the4_kalles_schema_metadata( array( 'context' => 'header' ) ); ?>>
    ...
    ?>
    <div class="header__mid pr pl__15 pr__15<?php echo esc_attr( ( cs_get_option( 'header-transparent' ) ? ' header__transparent w__100' : '' ) ); ?>">
        <div class="container">
