...
<header id="the4-header" class="header-14 <?php echo ( cs_get_option( 'menu-arrow' ) ? ' menu-item-arrow' : '' ); ?> <?php echo esc_attr( ( cs_get_option( 'menu-uppercase' ) ? ' menu-item-uppercase' : '' ) ); ?>" <?php the4_kalles_schema_metadata( array( 'context' => 'header' ) ); ?>>
    ...
    <div class="header__mid pl__15 pr__15<?php echo esc_attr( ( cs_get_option( 'header-transparent' ) ? ' header__transparent pa w__100' : '' ) ); ?>">
        <div class="container">
            <div class="row middle-xs al_center">
                ...
                <div class="col-lg-8 col-md-4 col-6 in_flex al_center ">
                    <nav class="the4-navigation col-md-5 hidden-sm hidden-xs flex fl_right pd__0">
                        <?php
                    ...
                    <div class="col-md-12 col-lg-2 tc col-sm-12 col-xs-12">
                        <?php the4_kalles_logo(); ?>
                    </div>
                    <nav class="the4-navigation col-md-5 hidden-sm hidden-xs pd__0">
                        <?php
