...
<div class="account-inner-content">
    <div class="row account-inner-content__heading">
        ...
        <div class="account-header">
            <h4 class="title-name"><?php esc_html_e( 'Hello', 'kalles' ); ?> <strong><?php echo esc_html( $current_user->display_name ); ?> </strong></h4>
            <p>
                <?php
    ...
    <ul class="account-list-action row w__100">
        <li class="col-md-6 col-12 mt__15">
            ...
            <a href="<?php echo esc_url( wc_get_endpoint_url( 'orders' ) ); ?>" class="acc-order">
                ...
                <span><?php esc_html_e( 'Your order', 'kalles' ); ?></span>
            </a>
