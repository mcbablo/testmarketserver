...
class OCDI_Plugin {
	...
	private function set_plugin_constants() {
		...
		if ( ! defined( 'OCDI_PATH' ) ) {
			...
			define( 'OCDI_PATH', KALLES_ADDONS_PATH  . 'includes' . DS . 'plugin' . DS . 'one-click-demo-import' . DS );
		}
		if ( ! defined( 'OCDI_URL' ) ) {
			define( 'OCDI_URL', KALLES_ADDONS_URL . '/includes/plugin/one-click-demo-import/' );
		}
		// Used for backward compatibility.
		if ( ! defined( 'PT_OCDI_PATH' ) ) {
			define( 'PT_OCDI_PATH', KALLES_ADDONS_PATH  . 'includes' . DS . 'plugin' . DS . 'one-click-demo-import' . DS );
		}
		if ( ! defined( 'PT_OCDI_URL' ) ) {
			define( 'PT_OCDI_URL', KALLES_ADDONS_URL .'/include/plugin/one-click-demo-import/');
		}
