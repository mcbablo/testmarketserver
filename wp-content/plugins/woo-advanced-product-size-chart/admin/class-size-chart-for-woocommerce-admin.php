...
class SCFW_Size_Chart_For_Woocommerce_Admin
{
    ...
    public function scfw_size_chart_menus( $current_post_type = null, $current_page = null )
    {
        ...
        $size_chart_menus = array(
            ...
            'size-chart-add-new'     => array(
            'menu_title' => __( 'Add New', 'size-chart-for-woocommerce' ),
            'menu_slug'  => 'size-chart-add-new',
            'menu_url'   => esc_url( $this->scfw_get_size_chart_menu_url( 'post-new.php', array(
            'post_type' => 'size-chart',
        ) ) ),
            'class'      => $this->scfw_get_menu_active_class( 'size-chart-post-new.php', array( $current_post_type, $pagenow ) ),
        ),
        ...
        if ( 'size-chart-post.php' === $typenow . '-' . $pagenow ) {
            $size_chart_menus['size-chart-add-new'] = array(
