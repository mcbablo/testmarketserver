                ...
                <div class="login-w-form-inner the4-account-form">
                    <div class="form-login-reset-wrap form-acc-wrap the4-acc-show">
                        <form method="post" class="woocommerce-form woocommerce-form-login login the4-form-show">
                            ...
                            <p class="form-row mb__0">
                                <?php wp_nonce_field( 'woocommerce-login', 'woocommerce-login-nonce' ); ?>
                                <span class="inline mb__5"><span class="style-checkbox">
                            <input class="woocommerce-form__input woocommerce-form__input-checkbox" name="rememberme" type="checkbox" id="rememberme" value="forever" /><label for="rememberme" class="checkbox"></label> <span><?php esc_html_e( 'Remember me', 'kalles' ); ?></span>
                                ...
                                <button type="submit" class="woocommerce-Button button" name="login" value="<?php esc_attr_e( 'Log in', 'kalles' ); ?>"><?php esc_html_e( 'Log in', 'kalles' ); ?></button>
                        ...
                        <form method="post" action="<?php echo esc_url( wc_lostpassword_url() ); ?>" class="woocommerce-form woocommerce-ResetPassword lost_reset_password">
                            ...
                            <p class="woocommerce-form-row form-row">
                                ...
                                <button type="submit" class="woocommerce-Button button pr" data-skey="<?php echo esc_attr( wp_create_nonce('kalles-forgot-ajax') ); ?>" value="<?php esc_attr_e( 'Reset password', 'kalles' ); ?>"><span><?php esc_html_e( 'Reset password', 'kalles' ); ?></span></button>
                            </p>
